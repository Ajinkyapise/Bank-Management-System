...
public class SignupOne extends JFrame implements ActionListener{
    ...
    JRadioButton male,female,marrried,unmarrried,others;
    ...
    SignupOne(){
        ...
        marrried = new JRadioButton("Marrried");
        marrried.setBounds(300,390,100,30);
        marrried.setBackground(Color.WHITE);
        add(marrried);
        unmarrried = new JRadioButton("Unmarrried");
        unmarrried.setBounds(450,390,100,30);
        ...
        //Selecting button
        ButtonGroup margroupo = new ButtonGroup();
        margroupo.add(marrried);
        margroupo.add(unmarrried);
        margroupo.add(others);
    ...
    public void actionPerformed (ActionEvent ae){
      String formno= ""+random;//Adding a string before any number makes it Long
      ...
      String marital = null;
      if(marrried.isSelected()){
          marital="Married";
      }else if(unmarrried.isSelected()){
          marital="Unmarried";
